...
export declare const tcbDescribeBaasPackageListContract: Factory<ITCTCBDescribeBaasPackageListInput, ITCTCBDescribeBaasPackageListOutput>;
export declare const tcbCreateBaasDealContract: Factory<ITCTCBCreateBaasDealInput, ITCTCBCreateBaasDealOutput>;
export declare const tcbModifyEnvExtraContract: Factory<ITCTCBModifyEnvExtraInput, ITCTCBModifyEnvExtraOutput>;
export declare const tcbCheckOnceOwnedEnvironmentContract: Factory<ITCTCBCheckOnceOwnedEnvironmentInput, ITCTCBCheckOnceOwnedEnvironmentOutput>;
export declare const tcbClaimVoucherForUserContract: Factory<ITCTCBClaimVoucherForUserInput, ITCTCBClaimVoucherForUserOutput>;
export declare const tcbDescribeModifyAbleBaasPackageContract: Factory<ITCTCBDescribeModifyAbleBaasPackageInput, ITCTCBDescribeModifyAbleBaasPackageOutput>;
export declare const tcbModifyClsTopicContract: Factory<ITCTCBModifyClsTopicInput, ITCTCBModifyClsTopicOutput>;
...
export declare const tcbModifyHeadlessEndUserContract: Factory<ITCTCBModifyHeadlessEndUserInput, ITCTCBModifyHeadlessEndUserOutput>;
