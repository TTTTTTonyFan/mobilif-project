...
export declare function tcbDescribeBaasPackageList(opts: IAPITCBDescribeBaasPackageListOptions): Promise<IAPITCBDescribeBaasPackageListResult>;
export declare function tcbCreateBaasDeal(opts: IAPITCBCreateBaasDealOptions): Promise<IAPITCBCreateBaasDealResult>;
export declare function tcbModifyEnvExtra(opts: IAPITCBModifyEnvExtraOptions): Promise<IAPITCBModifyEnvExtraResult>;
export declare function tcbCheckOnceOwnedEnvironment(opts: IAPITCBCheckOnceOwnedEnvironmentOptions): Promise<IAPITCBCheckOnceOwnedEnvironmentResult>;
export declare function tcbClaimVoucherForUser(opts: IAPITCBClaimVoucherForUserOptions): Promise<IAPITCBClaimVoucherForUserResult>;
export declare function tcbDescribeModifyAbleBaasPackage(opts: IAPITCBDescribeModifyAbleBaasPackageOptions): Promise<IAPITCBDescribeModifyAbleBaasPackageResult>;
export declare function tcbModifyClsTopic(opts: IAPITCBModifyClsTopicOptions): Promise<IAPITCBModifyClsTopicResult>;
...
export declare function tcbModifyHeadlessEndUser(opts: IAPITCBModifyHeadlessEndUserOptions): Promise<IAPITCBModifyHeadlessEndUserResult>;
